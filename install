...
cd /var/www/html
wget https://raw.githubusercontent.com/jailondanet2/Painel-v20/main/v20.zip > /dev/null 2>&1
...
sleep 1
cd
wget https://raw.githubusercontent.com/jailondanet2/Painel-v20/main/banco.sql > /dev/null 2>&1
sleep 1
...
cd /bin
wget https://raw.githubusercontent.com/jailondanet2/Painel-v20/main/html.sh > /dev/null 2>&1 && chmod 777 html.sh && sed -i -e 's/\r$//' html.sh && ./html.sh
